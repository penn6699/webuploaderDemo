(function ($) {
    ...
    var INTEROP_PATH = {
        ...
        //处理文件上传的地址
        server: ApiHost+'/Upload/ChunkUpload',
        //获取已上传文件的块数量
        GetMaxChunk: ApiHost+'/Upload/GetMaxChunk',
        //进行文件合并的地址
        MergeFiles: ApiHost+"/Upload/MergeFiles"
    };
    ...
    $(function () {
        ...
        uploader = WebUploader.create({
            ...
            fileSizeLimit: 1024 * 1024 * 1024*1024*1024,    // 1024 M
            fileSingleSizeLimit: 1024 * 1024 * 1024 * 1024 * 1024* 1024*1024    // 1024 M
        });
        ...
        function addFile(file) {
            ...
            if (file.getStatus() === 'invalid') {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (error) {
                        $wrap.text('不能预览');
                        $wrap.empty().append($('<img src="/js/webuploader/images/image.png">'));
